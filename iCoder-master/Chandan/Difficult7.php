...
<html lang="en">
 ...
 <div class="question my-4" style="padding-left: 5px;padding-right: 5px">
     <pre>
            ...
            and "unlucky" otherwise.He considered the army as "READY FOR BATTLE" 
            ...
            Input:
            The line of input consists of N space separated integers A1, A2, ..., AN, where Ai denotes the number of weapons that the ith soldier is holding.
  ...
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td><pre><strong>1</strong></pre></td>
      
    </tr>
   
    <tr>
      <th scope="row">2</th>
      <td><pre><strong>2</strong></pre></td>
     
    </tr>
    <tr>
      <th scope="row">3</th>
      <td><pre><strong>4</strong></pre></td>
      
    </tr>
    <tr>
      <th scope="row">4</th>
      <td><pre><strong>2 3 4</strong></pre></td>
    </tr>
...
<center>
  ...
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="Difficult6.php">Previous</a></li>
    ...
    <li class="page-item"><a class="page-link" href="Difficult7.php"><b>7</b></a></li>
    ...
    <li class="page-item"><a class="page-link" href="Difficult8.php">Next</a></li>
</nav>
</div>
</center>
