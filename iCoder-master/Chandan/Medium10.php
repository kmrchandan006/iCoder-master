...
<!-- navbar start -->
 ...
 <div class="question my-4" style="padding-left: 5px;padding-right: 5px">
     <pre>
                    <strong> 
                   <h3>
                    <strong>10).From heaven to earth</strong>
                   </h3>      
...
<center>
  ...
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="Medium9.php">Previous</a></li>
    ...
    <li class="page-item"><a class="page-link" href="Medium10.php"><b>10</b></a></li>
    <li class="page-item"><a class="page-link" href="Medium1.php">Next</a></li>
  </ul>
</nav>
</div>
</center>
