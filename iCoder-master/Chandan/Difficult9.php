...
<?php include('nav-bar.php'); ?>
 ...
 <div class="question my-4" style="padding-left: 5px;padding-right: 5px">
     <pre>
                    <strong> 
                   <h3>
                    <strong>9).Chef and Price Control</strong>
                    </h3>
...
<center>
  ...
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="Difficult8.php">Previous</a></li>
    ...
    <li class="page-item"><a class="page-link" href="Difficult9.php"><b>9</b></a></li>
    <li class="page-item"><a class="page-link" href="Difficult10.php">10</a></li>
    <li class="page-item"><a class="page-link" href="Difficult10.php">Next</a></li>
  </ul>
</nav>
</div>
</center>
