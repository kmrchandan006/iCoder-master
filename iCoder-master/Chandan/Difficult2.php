...
<html lang="en">
 ...
 <div class="question my-4" style="padding-left: 5px;padding-right: 5px">
     <pre>
                    <strong> 
                   <h3>
                    <strong>2).The Great Run</strong>
                   </h3>
            Vishal loves running. He often visits his favourite Nehru Park and runs for very long distances. 
            On one such visit he found that the number of girls in the park was unusually high. Now he wants to use. 
            this as an opportunity to impress a large number of girls with his awesome speed.
  ...
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td><pre><strong>7  2
2  4  8  1  2  1  8</strong></pre></td>
      
    </tr>
    <tr>
      <th scope="row">2</th>
      <td><pre><strong>5  3
3  1  2  5  1</strong></pre></td>
     
    </tr>
    <tr>
      <th scope="row">3</th>
      <td><pre><strong>4  1
4  5  2  3</strong></pre></td>
      
    </tr>
    <tr>
      <th scope="row">4</th>
      <td><pre><strong>6  4
7  5  1  2  9  40</strong></pre></td>
...
<center>
  ...
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="Difficult1.php">Previous</a></li>
    <li class="page-item"><a class="page-link" href="Difficult1.php">1</a></li>
    <li class="page-item"><a class="page-link" href="Difficult2.php"><b>2</b></a></li>
    ...
    <li class="page-item"><a class="page-link" href="Difficult3.php">Next</a></li>
  </ul>
</nav>
</div>
</center>
