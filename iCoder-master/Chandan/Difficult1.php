...
<html lang="en">
 ...
 <div class="question my-4" style="padding-left: 5px;padding-right: 5px">
     <pre>
                    <strong> 
                   <h3>
                    <strong>1).Coronavirus Spread</strong>
                   </h3>
...
<center>
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="Difficult1.php"><b>1</b></a></li>
    ...
    <li class="page-item"><a class="page-link" href="Difficult2.php">Next</a></li>
  </ul>
</nav>
</div>
</center>
