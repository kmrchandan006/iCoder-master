...
<html lang="en">
 ...
 <div class="question my-4" style="padding-left: 5px;padding-right: 5px">
     <pre>
                    <strong> 
                   <h3>
                    <strong>3).Tanu and Head-bob</strong>
                   </h3>
...
<center>
  ...
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="Difficult2.php">Previous</a></li>
    ...
    <li class="page-item"><a class="page-link" href="Difficult3.php"><b>3</b></a></li>
    ...
    <li class="page-item"><a class="page-link" href="Difficult4.php">Next</a></li>
  </ul>
</nav>
</div>
</center>
